...
def shares_pi_with(ang, vert):
    ### Within a single tetrahedron with angle structure ang (a member of {0,1,2}),
    ### given a vertex vert (a member of {0,1,2,3}), find the vertex at the other end
    ### of the pi edge from vert.
    other_part = [1,2,3]
