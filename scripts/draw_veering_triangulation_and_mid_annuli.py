...
direction_to_pyx_col = {'blue':blue, 'red':red}
...
def draw_triangle_num(canvas, veering_colours, vert_posns, tetrahedron, tri_num): #, offset_down = False):
    ...
    cols = [get_edge_between_verts_pyx_colour(veering_colours, tetrahedron, tri_verts[0], tri_verts[1]),
            get_edge_between_verts_pyx_colour(veering_colours, tetrahedron, tri_verts[1], tri_verts[2]),
            get_edge_between_verts_pyx_colour(veering_colours, tetrahedron, tri_verts[2], tri_verts[0])]
...
###           top[1]
    ...
    tetrahedron = triangulation.tetrahedron(tet_num)
    if is_upper_half:
        col = get_edge_between_verts_pyx_colour(veering_colours, tetrahedron, top_vertices[0], top_vertices[1])
        corner_indices = [3,0,1]
        tet_label_shift = 0.12*tet_width
    else:
        col = get_edge_between_verts_pyx_colour(veering_colours, tetrahedron, bottom_vertices[0], bottom_vertices[1])
