...
# compute the "big" and "small" veering polynomials as defined by Sam
# Taylor et al.  We also compute the alexander polynomial here, to
# ensure that we are using the same spanning tree.
...
def edges_to_triangles_matrix(triangulation, angle_structure, ZH, P, mode = "veering"):
    ...
    # In mode "veering" we are computing the matrix which assigns to a
