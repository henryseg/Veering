...
def draw_continent_circle(veering_isosig, max_num_tetrahedra = 50, draw_upper_landscape = True, draw_lower_landscape = False, draw_upper_green = True, draw_lower_purple = False):
    ...
    canv.stroke(pyx.path.circle(0,0,1), [pyx.style.linewidth(0.002)])
    ...
    print(len(con.triangles), len(con.vertices))
...
def main():
    ...
    draw_continent_circle(veering_isosig, max_num_tetrahedra = 25, 
